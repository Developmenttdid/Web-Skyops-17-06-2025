  ...
  if (searchTerm) {
    filtered = filtered.filter(
      (project) =>
        ...
        project.outTimestamp.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  if (sortOrder !== 'default') {
    filtered.sort((a, b) => {
      ...
      if (filterColumn === 'project code') {
        ...
        const dateA = a.outTimestamp === '-' ? '0' : a.outTimestamp;
        const dateB = b.outTimestamp === '-' ? '0' : b.outTimestamp;
        comparison = dateA.localeCompare(dateB);
      } else if (filterColumn === 'check in date') {
        const dateA = a.inTimestamp === '-' ? '0' : a.inTimestamp;
        const dateB = b.inTimestamp === '-' ? '0' : b.inTimestamp;
        comparison = dateA.localeCompare(dateB);
      }
